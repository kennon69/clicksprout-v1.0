      ...
      <section className="relative z-10 pt-16 sm:pt-20 pb-12 sm:pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            {/* Badge */}
            <div className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30 rounded-full text-blue-300 text-xs sm:text-sm font-medium backdrop-blur-sm mb-6 sm:mb-8 animate-bounce">
              <Flame className="w-3 h-3 sm:w-4 sm:h-4 mr-2 text-orange-400" />
              <span className="hidden sm:inline">#1 AI-Powered Product Promotion Platform</span>
              <span className="sm:hidden">#1 AI Product Platform</span>
              <ArrowUp className="w-3 h-3 sm:w-4 sm:h-4 ml-2 text-green-400" />
            </div>

            {/* Main Headline */}
            <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-8xl font-bold text-white mb-4 sm:mb-6 leading-tight">
              Transform
            ...
            <p className="text-base sm:text-xl md:text-2xl text-gray-300 mb-6 sm:mb-8 max-w-4xl mx-auto leading-relaxed px-2 sm:px-0">
              ...
              <span className="text-sm sm:text-lg text-gray-400 mt-2 sm:mt-4 block">No marketing experience required. Just paste, generate, and go viral.</span>
            </p>

            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mb-8 sm:mb-12 px-4 sm:px-0">
              <Link href="/submit">
                <Button size="lg" className="w-full sm:w-auto bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 shadow-2xl shadow-blue-500/25 transform hover:scale-110 transition-all duration-300 px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold tap-target no-select">
                  <Rocket className="w-5 h-5 sm:w-6 sm:h-6 mr-2 sm:mr-3" />
                  <span className="hidden sm:inline">Start Creating Viral Content</span>
                  <span className="sm:hidden">Start Creating</span>
                  <ArrowRight className="w-5 h-5 sm:w-6 sm:h-6 ml-2 sm:ml-3" />
                </Button>
              </Link>
              <Button size="lg" variant="outline" className="w-full sm:w-auto border-white/30 text-white hover:bg-white/10 backdrop-blur-sm px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold transform hover:scale-105 transition-all duration-300 tap-target no-select">
      ...
      <section className="relative z-10 py-8 sm:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-10">
            <h2 className="text-2xl sm:text-4xl md:text-6xl font-bold text-white mb-3 sm:mb-4">
              ...
              return (
                ...
                >
                  <div className={`bg-gradient-to-br ${feature.color} p-[1px] rounded-2xl`}>
                    <div className="bg-black/80 backdrop-blur-md rounded-2xl p-4 sm:p-6 hover:bg-black/60 transition-all duration-300 group h-full">
                      <div className="flex items-center justify-center mb-3 sm:mb-4">
                        <IconComponent className="w-8 h-8 sm:w-12 sm:h-12 text-white group-hover:scale-110 transition-transform duration-300" />
                      </div>
                      ...
                      <div className="text-xs text-blue-400 font-medium bg-blue-400/10 rounded-full px-2 sm:px-3 py-1 inline-block">
                        {feature.demo}
                      </div>
                    </div>
                  </div>
