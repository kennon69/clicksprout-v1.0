          ...
          <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
            <div className="flex items-center">
              <Button
                ...
                className="mr-3 sm:mr-4 flex items-center tap-target"
              >
              ...
              <div>
                <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white flex items-center">
                  <Settings className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 mr-2 sm:mr-3 text-blue-600" />
                  Settings
                </h1>
            ...
            {hasUnsavedChanges && (
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
                <span className="text-orange-600 dark:text-orange-400 text-sm text-center sm:text-left">
                  You have unsaved changes
                </span>
                <Button
                  onClick={handleSaveSettings}
                  disabled={saving}
                  className="flex items-center justify-center tap-target text-sm sm:text-base"
                >
